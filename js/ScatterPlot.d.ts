...
declare class ScatterPlot extends AbstractXYChart<ScatterData, "x", "y", ScatterConfig> {
    ...
    constructor(chartData: ChartData<ScatterData>, scatterConfig: ScatterConfig, drawConfig: DrawConfig);
    render(): void;
}
